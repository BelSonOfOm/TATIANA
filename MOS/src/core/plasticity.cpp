...
CriticalityMonitor::CriticalityMonitor(double default_epsilon_rho,
                                       std::size_t min_history, double quantile,
                                       std::size_t window)
    : default_epsilon_rho_(default_epsilon_rho), min_history_(min_history),
...
double CriticalityMonitor::epsilon_rho() const {
  if (rho_history_.size() < min_history_)
    return default_epsilon_rho_;
